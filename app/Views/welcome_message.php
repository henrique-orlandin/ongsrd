...
<head>
    <meta charset="UTF-8">
    <title>Bem-vindo ao CodeIgniter 4!</title>
    <meta name="description" content="O pequeno framework com recursos poderosos">
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-toggle">
                ...
                <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Documentacao</a>
            </li>
    ...
    <div class="heroe">
        ...
        <h2>O pequeno framework com recursos poderosos</h2>
...
<section>
    ...
    <p>A pagina que voce esta vendo e gerada dinamicamente pelo CodeIgniter.</p>

    <p>Se voce quiser editar esta pagina, ela esta em:</p>

    <pre><code>app/Views/welcome_message.php</code></pre>

    <p>O controller correspondente desta pagina esta em:</p>
...
<div class="further">
    ...
    <section>
        ...
        <p>O Guia do Usuario contem introducao, tutorial, varios guias de "como fazer"
            e documentacao de referencia para os componentes que formam o framework.
            Confira o <a href="https://codeigniter.com/user_guide/"
            target="_blank">Guia do Usuario</a> !</p>
        ...
        <h2>
           ...
           <p>CodeIgniter e um projeto open source desenvolvido pela comunidade, com varios
               canais para os membros se reunirem e trocarem ideias. Veja os topicos no
               <a href="https://forum.codeigniter.com/" target="_blank">forum do CodeIgniter</a>,
               ou <a href="https://join.slack.com/t/codeigniterchat/shared_invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q"
               target="_blank">converse no Slack</a> !</p>
        ...
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><line x1='176' y1='48' x2='336' y2='48' class="svg-stroke" /><line x1='118' y1='304' x2='394' y2='304' class="svg-stroke" /><path d='M208,48v93.48a64.09,64.09,0,0,1-9.88,34.18L73.21,373.49C48.4,412.78,76.63,464,123.08,464H388.92c46.45,0,74.68-51.22,49.87-90.51L313.87,175.66A64.09,64.09,0,0,1,304,141.48V48' class="svg-stroke" /></svg>
           ...
           <p>CodeIgniter e um projeto guiado pela comunidade e aceita contribuicoes
               de codigo e documentacao. Que tal
...
<footer>
    <div class="environment">
        ...
        <p>Pagina renderizada em {elapsed_time} segundos usando {memory_usage} MB de memoria.</p>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> CodeIgniter Foundation. CodeIgniter e um projeto open source licenciado sob a
            licenca MIT.</p>
